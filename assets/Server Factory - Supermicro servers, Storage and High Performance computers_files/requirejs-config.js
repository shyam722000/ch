...
var config = {
    map: {
        '*': {
            optionFeatures: 'Staylime_ApoMods/js/features-mixin',
        }
    }
};
...
var config = {
    map: {
        '*': {
            maxValuesQtyValidationRule: 'Staylime_ApoMods/js/maxValuesQtyValidationRule',
        }
    }
};
...
var config = {
    map: {
        '*': {
            WkYouTubeChannelFeed: 'Webkul_YouTubeChannelFeed/js/WkYouTubeChannelFeed',
        }
    }
};
